...
/**
 * The SearchService is a session EJB to search the solr index. The index is
 * maintained by the UpdateService EJB.
 * 
 * @see UpdateService
 * @version 1.0
 * @author rsoika
...
public class SearchService implements Serializable {
	...
	/**
	 * This method returns a list containing the current user name and roles the
	 * user is assigned to.
	 * <p>
	 * For a more fine granted access control search the imixs-micrsoervice
	 * instance.
	 * <p>
	 * 
	 * @see UserGroupEvent
