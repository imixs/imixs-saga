...
public class SolrUpdateService implements Serializable {
   ...
   * <p>
   * The method will return the documents containing all stored or DocValues fields.
   * 
   * 
   * @param searchterm
   * @return
   ...
   * <p>
   * The schema for the imixs-registry contains only stored fields. The field list is defined by the
   * DEFAULT_STORE_FIELD_LIST and the optional index.fields
   * 
   * <p>
   * 
   ...
   * are stored based on the ID of the document. Find also details in the Imixs-Workflow-Solr Index
   * implementation.
   * 
   * <p>
   * 
